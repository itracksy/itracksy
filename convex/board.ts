...
async function ensureBoardExists(ctx: QueryCtx, boardId: string): Promise<Doc<"boards">> {
...
async function ensureColumnExists(ctx: QueryCtx, columnId: string): Promise<Doc<"columns">> {
