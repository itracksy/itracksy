...
export const NOTIFICATION_SHOW_CHANNEL = "show-notification";
export const NOTIFICATION_EXTEND_SESSION_CHANNEL = "extend-session";
export const NOTIFICATION_READY_CHANNEL = "notification-ready";
