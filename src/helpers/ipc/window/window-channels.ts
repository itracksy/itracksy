...
export const WIN_START_TRACKING_CHANNEL = "window:startTracking";

export const WIN_STOP_TRACKING_CHANNEL = "window:stopTracking";
...
export const WIN_SET_USER_INFORMATION_CHANNEL = "window:setUserInformation";
