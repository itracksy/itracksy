...
export function AIAnalysis({ timeRange }: AIAnalysisProps) {
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-purple-700 dark:text-purple-300">
              Export your productivity data for AI analysis. Get personalized insights on context
              switching patterns, deep work blocks, and focus optimization strategies.
            </p>
          </div>
        </div>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-xs text-muted-foreground">
              Every app switch is detected and classified as <strong>macro</strong> (high cognitive
              cost), <strong>micro</strong> (quick glance), <strong>tab</strong> (browser), or{" "}
              <strong>interruption</strong> (messaging apps).
            </p>
          </CardContent>
        </Card>
      ...
      <Card className="border-amber-200 bg-amber-50/50 dark:border-amber-900 dark:bg-amber-950/20">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>
            Research shows it takes an average of <strong>23 minutes</strong> to fully regain focus
            after an interruption. Working in constant switching mode can lower functional IQ by{" "}
            <strong>10-15 points</strong>.
          </p>
          <p>
            This export quantifies your switching patterns so AI can identify your biggest triggers
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex flex-wrap items-center gap-4">
            <Tabs value={exportType} onValueChange={(v) => setExportType(v as "full" | "compact")}>
              <TabsList>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-lg font-semibold">{exportData.summary.totalContextSwitches}</p>
                </div>
                <div className="space-y-1">
                  <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                    <Zap className="h-3.5 w-3.5" />
                  ...
                  <p className="text-lg font-semibold">{exportData.summary.deepWorkBlocksCount}</p>
                </div>
              </div>
              ...
              <div className="mt-4 rounded-lg bg-muted/50 p-3">
                <div className="flex flex-wrap items-center gap-4 text-sm">
                  ...
                  <span>
                    Longest streak:{" "}
                    <strong>{formatDuration(exportData.summary.longestFocusStreakSeconds)}</strong>
                  </span>
                </div>
              </div>
            </CardContent>
